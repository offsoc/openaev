...
public class PyroscopeConfig {
  ...
  private static final String SCHEDULER_JOBS_PACKAGE = "io.openbas.scheduler.jobs";
  private static final String ENDPOINTS_PACKAGE = "io.openbas.rest";

  /** The pointcut to use. Targets all method in the package and subpackages io.openbas.rest */
  @Pointcut("execution(* io.openbas.scheduler.jobs..*.execute(..))")
